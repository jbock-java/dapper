...
final class OptionalFactories {
  ...
  private MethodSpec absentOptionalProviderMethod(OptionalKind optionalKind) {
    ...
    return methodBuilder(
        ...
        .addJavadoc(
            "Returns a {@code $T} that returns {@code $L}.",
            TypeNames.PROVIDER,
   ...
   *
   * <ul>
   *   <li>If {@code optionalRequestKind} is {@code RequestKind#INSTANCE}, the class implements
   *       {@code ProviderOrProducer<Optional<T>>}.
   *   <li>If {@code optionalRequestKind} is {@code RequestKind#PROVIDER}, the class implements
   *       {@code Provider<Optional<Provider<T>>>}.
   *   <li>If {@code optionalRequestKind} is {@code RequestKind#LAZY}, the class implements {@code
   *       Provider<Optional<Lazy<T>>>}.
   *   <li>If {@code optionalRequestKind} is {@code RequestKind#PROVIDER_OF_LAZY}, the class
   *       implements {@code Provider<Optional<Provider<Lazy<T>>>>}.
   *   <li>If {@code optionalRequestKind} is {@code RequestKind#PRODUCER}, the class implements
   *       {@code Producer<Optional<Producer<T>>>}.
   *   <li>If {@code optionalRequestKind} is {@code RequestKind#PRODUCED}, the class implements
