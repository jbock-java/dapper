...
import static dagger.internal.codegen.my.DaggerCollections.hasDuplicates;
import static dagger.internal.codegen.my.DaggerCollections.newHashSetWithExpectedSize;
import static dagger.internal.codegen.my.DaggerCollections.presizedList;
...
/**
 * A {@code Factory} implementation used to implement {@link Set} bindings. This factory always
 * returns a new {@link Set} instance for each call to {@link #get} (as required by {@link dagger.internal.Factory})
