...
public abstract class ComponentPath {
  /** Returns a new {@code ComponentPath} from {@code components}. */
  ...
  /**
   * Returns the component types, starting from the {@code #rootComponent() root
   * component} and ending with the {@code #currentComponent() current component}.
   */
  public abstract ImmutableList<DaggerTypeElement> components();

  /**
   * Returns the root {@code dagger.Component}- or {@code
  ...
  /**
   * Returns the parent of the {@code #currentComponent()} current component}.
   *
   * @throws IllegalStateException if the current graph is the {@code #atRoot() root component}
   */
  ...
  /**
   * Returns {@code true} if the {@code #currentComponent()} current component} is the
   * {@code #rootComponent()} root component}.
   */
