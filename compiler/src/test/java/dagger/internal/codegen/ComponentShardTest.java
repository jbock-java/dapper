        ...
        .containsLines(
            compilerMode
                ...
                .addLinesIn(
                    ...
                    "      @SuppressWarnings(\"unchecked\")",
                    "      private void initialize() {",
                    "        this.binding5Provider = DoubleCheck.provider(new SwitchingProvider<Binding5>(testComponentImpl, 4));",
                    "        this.binding4Provider = DoubleCheck.provider(new SwitchingProvider<Binding4>(testComponentImpl, 3));",
                    "        this.binding3Provider = DoubleCheck.provider(new SwitchingProvider<Binding3>(testComponentImpl, 2));",
                ...
                .addLinesIn(
                    ...
                    "      @SuppressWarnings(\"unchecked\")",
                    "      private void initialize() {",
                    "        this.binding1Provider = DoubleCheck.provider(Binding1_Factory.create(testComponentImpl.shard1.binding2Provider));",
                    "      }",
                    "    }")
                .addLinesIn(
                    FAST_INIT_MODE,
                    ...
                    "          return (T) new Binding1(testComponentImpl.shard1.binding2Provider.get());",
                    "",
                    "          case 1: // dagger.internal.codegen.Binding2 ",
                    "          return (T) new Binding2(testComponentImpl.shard1.binding3Provider.get());",
                    "",
                    "          case 2: // dagger.internal.codegen.Binding3 ",
                    "          return (T) new Binding3(testComponentImpl.shard1.binding4Provider.get());",
                    "",
                    "          case 3: // dagger.internal.codegen.Binding4 ",
                    "          return (T) new Binding4(testComponentImpl.shard1.binding5Provider.get(), testComponentImpl.shard1.binding2Provider);",
                    "",
