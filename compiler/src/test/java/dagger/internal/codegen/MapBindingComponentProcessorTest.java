  ...
  public void mapBindingsWithStringKey() throws IOException {
    ...
    String[] generatedComponent = compilerMode
        ...
        .addLinesIn(FAST_INIT_MODE,
            ...
            "  private volatile Provider<Handler> provideAdminHandlerProvider;",
            "  private volatile Provider<Handler> provideLoginHandlerProvider;",
            "  private volatile Provider<Map<String, Provider<Handler>>> mapOfStringAndProviderOfHandlerProvider;",
            "",
            "  private Provider<Handler> provideAdminHandlerProvider() {",
            "    Object local = provideAdminHandlerProvider;",
            "    if (local == null) {",
            ...
            "    if (local == null) {",
            "      local = new SwitchingProvider<>(testComponent, 0);",
            "      mapOfStringAndProviderOfHandlerProvider = (Provider<Map<String, Provider<Handler>>>) local;",
            "    }",
            ...
            "    public T get() {",
            "      switch (id) {",
            "        case 0: // java.util.Map<java.lang.String,jakarta.inject.Provider<test.Handler>> ",
            "        return (T) testComponent.mapOfStringAndProviderOfHandler();",
            "        case 1: // java.util.Map<java.lang.String,jakarta.inject.Provider<test.Handler>> test.MapModuleOne#provideAdminHandler ",
            "        return (T) MapModuleOne_ProvideAdminHandlerFactory.provideAdminHandler(testComponent.mapModuleOne);",
            "        case 2: // java.util.Map<java.lang.String,jakarta.inject.Provider<test.Handler>> test.MapModuleTwo#provideLoginHandler ",
            "        return (T) MapModuleTwo_ProvideLoginHandlerFactory.provideLoginHandler(testComponent.mapModuleTwo);",
            "        default: throw new AssertionError(id);",
            "      }",
            "    }",
        ...
        .addLinesIn(DEFAULT_MODE,
            ...
            "    this.provideAdminHandlerProvider = MapModuleOne_ProvideAdminHandlerFactory.create(mapModuleOneParam);",
            "    this.provideLoginHandlerProvider = MapModuleTwo_ProvideLoginHandlerFactory.create(mapModuleTwoParam);",
            "    this.mapOfStringAndProviderOfHandlerProvider = MapProviderFactory.<String, Handler>builder(2).put(\"Admin\", provideAdminHandlerProvider).put(\"Login\", provideLoginHandlerProvider).build();",
            "  }",
            "",
            "  @Override",
            "  public Provider<Map<String, Provider<Handler>>> dispatcher() {",
