...
public final class CodeBlocks {
  ...
  /**
   * Returns an anonymous {@code Provider} class with the single {@code
   * Provider#get()} method that returns the given {@code expression}.
   */
  ...
  /**
   * Returns an anonymous {@code Provider} class with the single {@code
   * Provider#get()} method implemented by {@code body}.
   */
