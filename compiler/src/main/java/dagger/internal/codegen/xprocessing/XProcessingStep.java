...
public interface XProcessingStep {
   ...
   *
   * @return the elements (a subset of the values of {@code elementsByAnnotation}) that this step is
   ...
   *
   * <p>Unlike {@code #process}, the elements in {@code elementsByAnnotation} are not validated and
   * are those that have been kept being deferred.
   */
  void processOver(
      XProcessingEnv env, Map<String, ? extends Set<? extends XElement>> elementsByAnnotation);
