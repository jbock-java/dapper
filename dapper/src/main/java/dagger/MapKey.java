 ...
 * array.
 *
 * <p>See {@code dagger.multibindings} for standard unwrapped map key annotations for keys that are
 * boxed primitives, strings, or classes.
 *
 * <h2>Annotations as keys</h2>
 *
 * <p>If {@code #unwrapValue} is false, then the annotation itself is used as the map key. For
 ...
 * order to call {@code Map#get(Object)} on the provided map.)
 *
