    ...
    switch (compilerMode) {
      case FAST_INIT_MODE:
        ...
        Collections.addAll(generatedComponent,
            ...
            "",
            "  private volatile Object productionImplementationExecutor = new MemoizedSentinel();",            "  private volatile Object productionComponentMonitor = new MemoizedSentinel();",
            "",
            ...
            "        if (local instanceof MemoizedSentinel) {",
            "          local = TestClass_BModule_ExecutorFactory.executor(bModule);",
            "          productionImplementationExecutor = DoubleCheck.reentrantCheck(productionImplementationExecutor, local);",
            "        }",
            "      }",
            "    }",
            ...
            "        if (local instanceof MemoizedSentinel) {",
            "          local = TestClass_SimpleComponent_MonitoringModule_MonitorFactory.monitor(simpleComponentProvider, SetFactory.<ProductionComponentMonitor.Factory>empty());",
            "          productionComponentMonitor = DoubleCheck.reentrantCheck(productionComponentMonitor, local);",
            "        }",
            "      }",
            "    }",
            ...
            "  }",
            "",
            "  private Provider<ProductionComponentMonitor> productionComponentMonitorProvider() {",
            ...
            "    this.aProducer = TestClass_AModule_AFactory.create(aModuleParam, productionImplementationExecutorProvider(), productionComponentMonitorProvider(), bProducer);",
            ...
            "    public T get() {",
            "      switch (id) {",
            "        case 0: // @dagger.producers.internal.ProductionImplementation java.util.concurrent.Executor ",
            "        return (T) simpleComponent.productionImplementationExecutor();",
            "",
            "        case 1: // dagger.producers.monitoring.ProductionComponentMonitor ",
            "        return (T) simpleComponent.productionComponentMonitor();",
            "",
            "        case 2: // test.TestClass.B ",
            "        return (T) simpleComponent.b();",
            "",
